      ...
      {CATEGORIES.map((cat, index) => {
        ...
        return (
          <button
            ...
            className={`flex min-h-[100px] cursor-pointer flex-col items-center justify-center gap-3 rounded-xl border bg-white p-4 transition-all duration-200 ${
              isSelected
          ...
          >
            ...
            <span
              className={`text-sm font-semibold ${isSelected ? 'text-[#059669]' : 'text-slate-600'}`}
            >
              {cat.label}
            </span>
          </button>
