...
export default function Badge({ children, variant = 'leaf', size = 'md', icon }: BadgeProps) {
  return (
    <span
      className={`inline-flex items-center gap-1 rounded-full font-semibold tracking-wide uppercase ${variantStyles[variant]} ${sizeStyles[size]} `.trim()}
    >
