...
export default function App() {
  return (
    <BrowserRouter>
      <div className="flex h-screen bg-[var(--bg-background)] overflow-hidden transition-colors duration-300">
        {/* Sidebar */}
        <Navbar />
        
        {/* Main Content Area */}
        <main id="main-content" tabIndex={-1} className="flex-1 overflow-y-auto p-4 sm:p-8">
          <Suspense fallback={<div className="h-full flex items-center justify-center"><Spinner label="Loading page..." /></div>}>
            <Routes>
              {/* Public route */}
